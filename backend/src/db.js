...
async function seedData() {
  ...
  const rice = await Product.create({
    name_zh: '东北优质大米', name_en: 'Premium Northeast Rice', name_ko: '동북 프리미엄 쌀',
    ...
    category: 'rice', image_url: 'https://picsum.photos/seed/rice/800/600',
  });
  const dates = await Product.create({
    name_zh: '新疆特级大枣', name_en: 'Xinjiang Premium Red Dates', name_ko: '신장 프리미엄 대추',
    ...
    category: 'dates', image_url: 'https://picsum.photos/seed/dates/800/600',
  });
...
module.exports = { sequelize, Product, ProductVariant, Order, OrderItem, LogisticsTrack, Admin, initDb };
